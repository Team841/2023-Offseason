...
public class SuperstructureStatePreset {
    ...
    public SuperstructureStatePreset(States state, Double shoulder, Double elbow, Double elbow_tolerance, Double shoulder_tolerance){
    ...
    public boolean inPreset(Double shoulder_angle, Double elbow_angle){
        if ((this.shoulder - this.shoulder_tolerance) < shoulder_angle && shoulder_angle < (this.shoulder + this.shoulder_tolerance) &&
                (this.elbow - this.elbow_tolerance) < elbow_angle && elbow_angle < (this.elbow + this.elbow_tolerance)){
