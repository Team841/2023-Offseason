...
public final class SC {
  ...
  public static class PresetPositions {
    ...
    public static final SuperstructureStatePreset HomePreset =
        new SuperstructureStatePreset(
            States.Home, Home[0], Home[1], Shoulder.tolerance, Elbow.tolerance);
    public static final SuperstructureStatePreset IntermediatePreset =
        new SuperstructureStatePreset(
            States.Intermediate,
            Intermediate[0],
            Intermediate[1],
            Shoulder.tolerance,
            Elbow.tolerance);
    public static final SuperstructureStatePreset PreExtractInPreset =
        new SuperstructureStatePreset(
            States.PreIntermediate,
            PreExtractIn[0],
            PreExtractIn[1],
            Shoulder.tolerance,
            Elbow.tolerance);
    public static final SuperstructureStatePreset MidScoreCubePreset =
        new SuperstructureStatePreset(
            States.MidScoreCube,
            MidScoreCube[0],
            MidScoreCube[1],
            Shoulder.tolerance,
            Elbow.tolerance);
    public static final SuperstructureStatePreset HighScoreCubePreset =
        new SuperstructureStatePreset(
            States.TopScoreCube,
            HighScoreCube[0],
            HighScoreCube[1],
            Shoulder.tolerance,
            Elbow.tolerance);
    public static final SuperstructureStatePreset HighScoreConePreset =
        new SuperstructureStatePreset(
            States.TopScoreCone,
            HighScoreCone[0],
            HighScoreCone[1],
            Shoulder.tolerance,
            Elbow.tolerance);
    public static final SuperstructureStatePreset MidScoreConePreset =
        new SuperstructureStatePreset(
            States.MidScoreCone,
            MidScoreCone[0],
            MidScoreCone[1],
            Shoulder.tolerance,
            Elbow.tolerance);
    public static final SuperstructureStatePreset GroundPreset =
        new SuperstructureStatePreset(
            States.Ground, Ground[0], Ground[1], Shoulder.tolerance, Elbow.tolerance);
  }
}
